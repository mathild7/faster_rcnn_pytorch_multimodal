...
for var in var_arr:
    ...
    for value in pred_values:
        ...
        ce_norm = F.cross_entropy(logit_val,torch.tensor([0],dtype=torch.long))
        ce_norm_var = F.cross_entropy(dist_logit_val,dummy_sel.repeat(NUM_SAMPLES),reduction='none')
        ...
        norm_vector.append(ce_norm)
        dist_vector.append(ce_dist_loss)
